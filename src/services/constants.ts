...
export const throttling = {
  ...
  // These values align with OpenSignal's definition of "Average Singapore 4G Network"
  // https://www.opensignal.com/reports/2019/06/singapore/mobile-network-experience
  mobileSG4G: {
    rttMs: 30,
    throughputKbps: 40 * 1024,
    requestLatencyMs: 30 * DEVTOOLS_RTT_ADJUSTMENT_FACTOR,
    downloadThroughputKbps: 40 * 1024 * DEVTOOLS_THROUGHPUT_ADJUSTMENT_FACTOR,
 ...
 */
export const MOTOG4_EMULATION_METRICS = {
  mobile: true,
  width: 360,
  height: 640,
...
// eslint-disable-next-line max-len
export const DESKTOP_USERAGENT =
